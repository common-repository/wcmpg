...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_3__.getSetting)(wcmpg_params['name'] + '_data', {});
const label = (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_2__.decodeEntities)(settings.title || 'WCMPG Payment');
/**
 * Content component
 */
const Content = () => {
...
(0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_1__.registerPaymentMethod)(wcmpg);
})();
